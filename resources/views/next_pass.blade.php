...
<head>
  ...
  <title>Ticketing - Next - Step</title>
          ...
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form action="{{route('modifier_password')}}" method="post">
                    @csrf
                    ...
                    <input type="submit" class="btn btn-danger w-100 py-8 fs-4 mb-4 rounded-2" value="Changer mot de passe"/>
                </form>
              </div>
            </div>
          </div>
